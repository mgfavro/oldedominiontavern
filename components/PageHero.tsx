  ...
  return (
    <header className="relative overflow-hidden border-b border-line">
      ...
      <div className="relative mx-auto max-w-[1240px] px-6 py-24 md:px-8 md:py-28">
        ...
        <h1 className="hero-text font-display text-[clamp(40px,7vw,84px)] font-semibold leading-[0.98]">
          {title}
        </h1>
        {subtitle && (
          <p className="hero-text mt-5 max-w-xl font-sans text-[17px] font-medium leading-relaxed">
            {subtitle}
          </p>
        )}
      </div>
